package com.example.neverforgetagain.Adapter;
...
import com.example.neverforgetagain.R;
...
public class CheckListAdapter extends RecyclerView.Adapter<CheckListViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CheckListViewHolder holder, int position) {
        ...
        //Here can be error as getChecked wasn't made by ..
        ...
        if(MyConstants.FALSE_STRING.equals(show)){
            ...
            if(itemsList.get(position).isChecked()){
                holder.layout.setBackgroundColor(Color.parseColor("#8062D6"));
            }else{
                holder.layout.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.border_one));
            }
        }
