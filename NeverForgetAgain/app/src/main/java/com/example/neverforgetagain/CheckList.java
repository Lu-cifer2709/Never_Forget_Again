...
import com.example.neverforgetagain.Adapter.CheckListAdapter;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.btnMySelections) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("Are You Sure!!\n\nAs this will load all the data provided by (Never Forget Again)" +
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("Are You Sure!!\n\nAs this will delete all the data provided by (Never Forget Again) while installing")
                    .setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
            ...
            this.finishAffinity();
            Toast.makeText(this, "Never Forget Again\nExit Completed", Toast.LENGTH_SHORT).show();
            return true;
        }
